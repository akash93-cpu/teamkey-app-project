    ...
    return (
        ...
        <div className='stat-page-section-1'>
            ...
            <p>Match-level analytics provides detailed statistical data on each and every match. Each game is analyzed using metrics such as 3-point and 2-point shots and also
                with the most common actions for each teams per game. These provide further insights to identifying trends for all teams using AI powered technologies. 
            </p>
            <Button>Go to match statistics</Button>
        </div>
        <div className='stat-page-section-2'>
            ...
            <Button>Go to team statistics</Button>
        </div>
        </>
    )
}